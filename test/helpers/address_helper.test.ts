...
const addrP = 'P-axc19v8flm9qt2gv2tctztjjerlgs4k3vgjsfw8udh';
const addrX = 'X-axc19v8flm9qt2gv2tctztjjerlgs4k3vgjsfw8udh';
...
describe('validate address', () => {
    ...
    it('should fail for random chain id', () => {
        let address = 'F-axc19v8flm9qt2gv2tctztjjerlgs4k3vgjsfw8udh';
        //@ts-ignore
