...
describe('Reduce parent balance of UniversalNode P', () => {
    ...
    it('all parents have balance of 1 AXC', () => {
...
describe('Reduce parent balance of UniversalNode X', () => {
    ...
    it('all nodes have balance of 1 AXC', () => {
        let balX = new BN(1000000000);
        let balP = new BN(1000000000);
        let balC = new BN(1000000000);
    ...
    it('both parents have balance of 1 AXC', () => {
        let balX = new BN(0);
        let balP = new BN(1000000000);
        let balC = new BN(1000000000);
    ...
    it('parent P has balance of 1 AXC', () => {
        let balX = new BN(0);
        let balP = new BN(1000000000);
        let balC = new BN(0);
    ...
    it('parent C has balance of 1 AXC', () => {
        let balX = new BN(0);
        let balP = new BN(0);
        let balC = new BN(1000000000);
...
describe('Reduce parent balance of UniversalNode C', () => {
    ...
    it('parent X has balance of 1 AXC', () => {
        let balX = new BN(1000000000);
        let balP = new BN(0);
        let balC = new BN(0);
...
describe('Get transactions for balance on UniversalNode P', () => {
    ...
    it('node needs balance from both parents and self', () => {
        let balP = new BN(1_000_000_000); // 1 AXC
        let balX = new BN(500_000_000); // 0.5 AXC
        let balC = new BN(2_000_000_000); // 2 AXC

        let nodeP = createGraphForP(balX, balP, balC, FEE_XP, FEE_C);
        let target = new BN(2_000_000_000); // 2 AXC
    ...
    it('node needs balance from both parents', () => {
        let balP = new BN(0); // 0 AXC
        let balX = new BN(1_000_000_000); // 1 AXC
        let balC = new BN(2_000_000_000); // 2 AXC
    ...
    it('not enough balance', () => {
        ...
        let nodeP = createGraphForP(balX, balP, balC, FEE_XP, FEE_C);
        let target = new BN(20_000_000_000); // 2 AXC
...
describe('Get transactions for balance on UniversalNode X', () => {
    ...
    it('node needs balance from parent P', () => {
        let balX = new BN(0);
        let balP = new BN(5_000_000_000); // 5 AXC
        let balC = new BN(0);
    ...
    it('node needs balance from P, both parent have balance', () => {
        let balX = new BN(0);
        let balP = new BN(5_000_000_000); // 5 AXC
        let balC = new BN(5_000_000_000); // 5 AXC
    ...
    it('node needs balance from both parents', () => {
        ...
        let nodeX = createGraphForX(balX, balP, balC, FEE_XP, FEE_C);
        let target = new BN(1_000_000_000); // 1 AXC
    ...
    it('not enough balance', () => {
        let balP = new BN(1_000_000_000); // 0 AXC
        let balX = new BN(1_000_000); // 1 AXC
        let balC = new BN(2_000_000_000); // 2 AXC
