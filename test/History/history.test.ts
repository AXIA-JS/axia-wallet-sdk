...
import { OrteliusAxiaTx } from '@/Explorer/ortelius/types';
...
jest.mock('@/Network/utils', () => {
    return {
        getAxcAssetID: jest.fn().mockImplementation(() => {
...
describe('Import Tx', () => {
    it('single utxo import, all belong to wallet. P to X', async () => {
        let data: OrteliusAxiaTx = JSON.parse(ImportTransaction);
    ...
    it('multiple import utxos, P to X', async () => {
        let data: OrteliusAxiaTx = JSON.parse(ImportTx1);
        const myAddresses = [
...
describe('Export Tx', () => {
    it('multiple utxo export to C chain, all belong to wallet', async () => {
        let data: OrteliusAxiaTx = JSON.parse(ExportTx);
        const myAddresses = [
    ...
    it('multiple utxos, P to X, with change utxo', async () => {
        let data: OrteliusAxiaTx = JSON.parse(ExportTx1);
        const myAddresses = [
    ...
    it('single utxo, X to C', async () => {
        let data: OrteliusAxiaTx = JSON.parse(ExportTx2);
        const myAddresses = [
    ...
    it('export C to X, single utxo', async () => {
        let data: OrteliusAxiaTx = JSON.parse(ExportTx3);
...
describe('Base Transaction Receive', () => {
    it('Simple receive AXC, faucet drip', async () => {
        let data: OrteliusAxiaTx = JSON.parse(BaseTx);
    ...
    it('Receive single ANT token', async () => {
        let data: OrteliusAxiaTx = JSON.parse(BaseTx1);
    ...
    it('Receive 2 ANT tokens', async () => {
        let data: OrteliusAxiaTx = JSON.parse(BaseTx2);
...
describe('Base Transaction Send', () => {
    it('Simple send AXC', async () => {
        let data: OrteliusAxiaTx = JSON.parse(BaseTxSend0);
    ...
    it('Send 1000 AXC', async () => {
        let data: OrteliusAxiaTx = JSON.parse(BaseTxSend1);
        const myAddresses = [
    ...
    it('Send 2 ANTs', async () => {
        let data: OrteliusAxiaTx = JSON.parse(BaseTxSend2);
        const myAddresses = [
            'X-fuji1lcx7plqaajp6730hh7pvyk9l3urjm6auxc3fx5',
            'X-fuji1ysxw3923qapq43pukde9vud4wn84exyzdqletm',
...
describe('Staking TX', () => {
    it('Add validator 100 AXC, staking finished, not rewarded', async () => {
        let data: OrteliusAxiaTx = JSON.parse(StakeTx0);
        const myAddresses = [
            'P-fuji1ur873jhz9qnaqv5qthk5sn3e8nj3e0kmafyxut',
    ...
    it('Add delegator 100 AXC, uses lockedstakeable UTXOs, stake finished, rewarded', async () => {
        let data: OrteliusAxiaTx = JSON.parse(StakeTx1);
        const myAddresses = [
            'P-fuji1ur873jhz9qnaqv5qthk5sn3e8nj3e0kmafyxut',
    ...
    it('Fee received from delegator 0.000225438 AXC', async () => {
        let data: OrteliusAxiaTx = JSON.parse(StakeTx2);
    ...
    it('Add validator, stake finished, rewarded', async () => {
        let data: OrteliusAxiaTx = JSON.parse(StakeTx3);
        const myAddresses = [
            'P-fuji1lzrmf3crp62ayj2kqwh9mzc5es9xv7q6cm00vl',
            'P-fuji1ur873jhz9qnaqv5qthk5sn3e8nj3e0kmafyxut',
