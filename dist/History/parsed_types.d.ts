...
export declare type HistoryItemTypeName = HistoryImportExportTypeName | 'transaction' | 'transaction_evm' | 'add_nominator' | 'add_validator' | 'delegation_fee' | 'validation_fee' | 'not_supported';
