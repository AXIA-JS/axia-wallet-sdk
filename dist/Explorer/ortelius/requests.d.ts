import { OrteliusAxiaTx, OrteliusEvmTx } from "./..";
/**
 ...
 * @param txID
 */
export declare function getTx(txID: string): Promise<OrteliusAxiaTx>;
/**
 ...
 * @param endTime
 */
export declare function getAddressHistory(addrs: string[], limit: number | undefined, chainID: string, endTime?: string): Promise<OrteliusAxiaTx[]>;
/**
